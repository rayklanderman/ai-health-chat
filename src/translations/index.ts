export const translations = {
  en: {
    ...
    backOnlineMessage: 'You are now connected to the internet.',
  ...
  sw: {
    ...
    offlineMessage: 'Huna mtandao kwa sasa. Baadhi ya huduma zinaweza kuwa na vikwazo.',
    tryReconnect: 'Jaribu kuunganisha tena',
    backOnline: 'Mtandao Umerudi',
    backOnlineMessage: 'Sasa umeunganishwa na mtandao.',
    errorMessage: 'Samahani, nimekumbana na hitilafu. Tafadhali jaribu tena.',
  },
  fr: {
    ...
    sendButton: 'Envoyer',
    sendingButton: 'Envoi...',
    offlineMessage: 'Vous êtes actuellement hors ligne. Certaines fonctionnalités peuvent être limitées.',
    tryReconnect: 'Essayer de se reconnecter',
    backOnline: 'De Retour en Ligne',
    backOnlineMessage: 'Vous êtes maintenant connecté à Internet.',
    errorMessage: 'Je suis désolé, mais j\'ai rencontré une erreur. Veuillez réessayer.',
  }
};
